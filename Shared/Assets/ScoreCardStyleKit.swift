...
public class ScoreCardStyleKit : NSObject {
    ...
    public dynamic class func drawCard(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 235, height: 356), resizing: ResizingBehavior = .aspectFit, holeNumber: String = "3", name1: String = "Kenny", name2: String = "Jonah", player1Hole1: String = "2", player1Hole2: String = "2", player1Hole3: String = "2", player1Hole4: String = "2", player1Hole5: String = "2", player1Hole6: String = "2", player1Hole8: String = "2", player1Hole9: String = "2", player2Hole1: String = "2", player2Hole2: String = "2", player2Hole3: String = "2", player2Hole4: String = "2", player2Hole5: String = "2", player2Hole6: String = "2", player2Hole7: String = "2", player2Hole8: String = "2", player2Hole9: String = "2", parHole1: String = "3", parHole2: String = "3", parHole3: String = "3", parHole4: String = "3", parHole5: String = "3", parHole6: String = "3", parHole7: String = "3", parHole8: String = "3", parHole9: String = "3", parTotal: String = "27", player1Total: String = "18", player2Total: String = "18") {
        ...
        sideCardPath.move(to: CGPoint(x: 35, y: 341))
        sideCardPath.addCurve(to: CGPoint(x: 0, y: 307), controlPoint1: CGPoint(x: 35, y: 324), controlPoint2: CGPoint(x: 0, y: 325))
        sideCardPath.addCurve(to: CGPoint(x: 0, y: 182), controlPoint1: CGPoint(x: 0, y: 286), controlPoint2: CGPoint(x: 0, y: 182))
        sideCardPath.addLine(to: CGPoint(x: 35, y: 182))
        sideCardPath.addCurve(to: CGPoint(x: 35, y: 341), controlPoint1: CGPoint(x: 35, y: 182), controlPoint2: CGPoint(x: 35, y: 358))
        sideCardPath.close()
        sideCardPath.move(to: CGPoint(x: 35, y: 66))
        sideCardPath.addCurve(to: CGPoint(x: 0, y: 100), controlPoint1: CGPoint(x: 35, y: 83), controlPoint2: CGPoint(x: 0, y: 82))
        sideCardPath.addCurve(to: CGPoint(x: 0, y: 182), controlPoint1: CGPoint(x: 0, y: 121), controlPoint2: CGPoint(x: 0, y: 182))
        sideCardPath.addLine(to: CGPoint(x: 35, y: 182))
        sideCardPath.addCurve(to: CGPoint(x: 35, y: 66), controlPoint1: CGPoint(x: 35, y: 182), controlPoint2: CGPoint(x: 35, y: 49))
        sideCardPath.close()
        color6.setFill()
        sideCardPath.fill()
        ...
        //// Text 13 Drawing
        let text13Rect = CGRect(x: 14, y: 4, width: 21, height: 16)
        let text13Style = NSMutableParagraphStyle()
        text13Style.alignment = .center
        let text13FontAttributes = [NSFontAttributeName: UIFont(name: "Neutraface2Display-Titling", size: 14)!, NSForegroundColorAttributeName: color3, NSParagraphStyleAttributeName: text13Style]

        parTotal.draw(in: text13Rect, withAttributes: text13FontAttributes)
        ...
        player1Hole8.draw(in: text18Rect, withAttributes: text18FontAttributes)
        ...
        //// Text 3 Drawing
        let text3Rect = CGRect(x: 119, y: 23, width: 35, height: 52)
        let text3Style = NSMutableParagraphStyle()
        text3Style.alignment = .center
        let text3FontAttributes = [NSFontAttributeName: UIFont(name: "Neutraface2Display-Titling", size: 60)!, NSForegroundColorAttributeName: UIColor.black, NSParagraphStyleAttributeName: text3Style]
    ...
    public dynamic class func imageOfCard(holeNumber: String = "3", name1: String = "Kenny", name2: String = "Jonah", player1Hole1: String = "2", player1Hole2: String = "2", player1Hole3: String = "2", player1Hole4: String = "2", player1Hole5: String = "2", player1Hole6: String = "2", player1Hole8: String = "2", player1Hole9: String = "2", player2Hole1: String = "2", player2Hole2: String = "2", player2Hole3: String = "2", player2Hole4: String = "2", player2Hole5: String = "2", player2Hole6: String = "2", player2Hole7: String = "2", player2Hole8: String = "2", player2Hole9: String = "2", parHole1: String = "3", parHole2: String = "3", parHole3: String = "3", parHole4: String = "3", parHole5: String = "3", parHole6: String = "3", parHole7: String = "3", parHole8: String = "3", parHole9: String = "3", parTotal: String = "27", player1Total: String = "18", player2Total: String = "18") -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 235, height: 356), false, 0)
            ScoreCardStyleKit.drawCard(holeNumber: holeNumber, name1: name1, name2: name2, player1Hole1: player1Hole1, player1Hole2: player1Hole2, player1Hole3: player1Hole3, player1Hole4: player1Hole4, player1Hole5: player1Hole5, player1Hole6: player1Hole6, player1Hole8: player1Hole8, player1Hole9: player1Hole9, player2Hole1: player2Hole1, player2Hole2: player2Hole2, player2Hole3: player2Hole3, player2Hole4: player2Hole4, player2Hole5: player2Hole5, player2Hole6: player2Hole6, player2Hole7: player2Hole7, player2Hole8: player2Hole8, player2Hole9: player2Hole9, parHole1: parHole1, parHole2: parHole2, parHole3: parHole3, parHole4: parHole4, parHole5: parHole5, parHole6: parHole6, parHole7: parHole7, parHole8: parHole8, parHole9: parHole9, parTotal: parTotal, player1Total: player1Total, player2Total: player2Total)
