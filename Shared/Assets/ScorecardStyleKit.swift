...
public class ScorecardStyleKit : NSObject {
    ...
    private struct Cache {
        ...
        static var imageOfContinueButtonPressed: UIImage?
        static var continueButtonPressedTargets: [AnyObject]?
    }
    ...
    public dynamic class func drawContinueButtonPressed(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 200, height: 44), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Color Declarations
        let gradient4Color = UIColor(red: 0.153, green: 0.863, blue: 0.286, alpha: 1.000)
        let gradient4Color2 = UIColor(red: 0.111, green: 0.625, blue: 0.208, alpha: 1.000)
        ...
        context.drawLinearGradient(gradient4, start: CGPoint(x: 100, y: -0), end: CGPoint(x: 100, y: 44), options: [])
        context.restoreGState()
    ...
    public dynamic class var imageOfContinueButtonPressed: UIImage {
        if Cache.imageOfContinueButtonPressed != nil {
            return Cache.imageOfContinueButtonPressed!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 200, height: 44), false, 0)
            ScorecardStyleKit.drawContinueButtonPressed()

        Cache.imageOfContinueButtonPressed = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
    ...
    @IBOutlet dynamic var continueButtonPressedTargets: [AnyObject]! {
        get { return Cache.continueButtonPressedTargets }
        set {
            Cache.continueButtonPressedTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: ScorecardStyleKit.imageOfContinueButtonPressed)
            }
        }
    }
