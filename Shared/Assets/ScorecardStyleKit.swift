...
public class ScorecardStyleKit : NSObject {
    ...
    public dynamic class func drawCard2(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 235, height: 355), resizing: ResizingBehavior = .aspectFit, color3: UIColor = UIColor(red: 0.012, green: 0.549, blue: 0.875, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 235, height: 355), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 235, y: resizedFrame.height / 355)


        //// Symbol Drawing
        let symbolRect = CGRect(x: 35, y: 311, width: 200, height: 44)
        context.saveGState()
        context.clip(to: symbolRect)
        context.translateBy(x: symbolRect.minX, y: symbolRect.minY)
        ...
        //// Symbol 2 Drawing
        let symbol2Rect = CGRect(x: 0, y: 70, width: 35, height: 242)
        context.saveGState()
        context.clip(to: symbol2Rect)
        context.translateBy(x: symbol2Rect.minX, y: symbol2Rect.minY)
        ...
        //// Symbol 3 Drawing
        let symbol3Rect = CGRect(x: 35, y: 0, width: 200, height: 311)
        context.saveGState()
        context.clip(to: symbol3Rect)
        context.translateBy(x: symbol3Rect.minX, y: symbol3Rect.minY)
    ...
    public dynamic class func imageOfCard2(color3: UIColor = UIColor(red: 0.012, green: 0.549, blue: 0.875, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 235, height: 355), false, 0)
